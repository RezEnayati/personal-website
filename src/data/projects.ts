...
export const projects: Project[] = [
  {
    id: 'rezai',
    title: 'rezai',
    description: 'AI chatbot fine-tuned on personal Q&A data using direct preference optimization',
  ...
  },
  {
    ...
    tech: ['SwiftUI', 'Kotlin', 'FastAPI', 'Embeddings', 'OpenAI', 'Pinecone', 'RAG'],
  ...
  },
  {
    id: 'rezume',
    title: 'rezume',
    description: 'AI-powered resume tailoring tool for job-specific applications',
  ...
  },
  {
    ...
    description: 'Real-time digit recognition with interactive drawing interface',
  ...
  },
  {
    ...
    description: 'iOS app for calculating food costs with real-time pricing engine',
    tech: ['SwiftUI', 'MVVM'],
